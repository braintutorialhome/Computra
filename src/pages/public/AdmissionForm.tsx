...
export default function AdmissionForm() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-[#131b2d] flex items-center justify-center p-6 relative overflow-hidden">
  ...
  return (
    <div className="min-h-screen bg-[#131b2d] py-20 px-6 font-sans relative overflow-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
