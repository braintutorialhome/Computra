...
export default function AdmissionForm() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-[#0d1f22] flex items-center justify-center p-6 relative overflow-hidden">
  ...
  return (
    <div className="min-h-screen bg-[#0d1f22] py-20 px-6 font-sans relative overflow-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
