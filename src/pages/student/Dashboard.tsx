...
export default function StudentDashboard() {
  ...
  if (!currentStudent) {
    return (
      <div className="min-h-screen bg-[#131b2d] text-slate-300 flex flex-col items-center justify-center p-6 text-center">
  ...
  return (
    <div className="min-h-screen bg-[#131b2d] text-slate-300 flex overflow-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
